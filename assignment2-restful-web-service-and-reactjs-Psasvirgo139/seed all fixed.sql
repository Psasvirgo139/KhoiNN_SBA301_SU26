...
-- SQL Server Seed Data Script for system_account
-- Database name: A2Khoi_sba301
...
IF NOT EXISTS (SELECT 1 FROM system_account WHERE AccountID = 1)
BEGIN
    INSERT INTO system_account (AccountID, account_name, account_email, account_role, account_password)
...
IF NOT EXISTS (SELECT 1 FROM system_account WHERE AccountID = 2)
BEGIN
    INSERT INTO system_account (AccountID, account_name, account_email, account_role, account_password)
...
IF NOT EXISTS (SELECT 1 FROM system_account WHERE AccountID = 3)
BEGIN
    INSERT INTO system_account (AccountID, account_name, account_email, account_role, account_password)
...
BEGIN
    INSERT INTO Category (CategoryID, category_name, category_desciption, parent_categoryid, is_active)
...
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (1, N'Breaking', N'Urgent or highly important news updates');
    PRINT '  - Inserted tag: #Breaking';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 2)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (2, N'Economy', N'Related to finance, economy, markets');
    PRINT '  - Inserted tag: #Economy';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 3)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (3, N'Innovation', N'New technologies, research, ideas');
    PRINT '  - Inserted tag: #Innovation';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 4)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (4, N'Championship', N'Sports tournaments, cups, events');
    PRINT '  - Inserted tag: #Championship';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 5)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (5, N'World', N'International news coverage');
    PRINT '  - Inserted tag: #World';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 6)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (6, N'Health', N'Healthcare, wellness, medicine');
    PRINT '  - Inserted tag: #Health';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 7)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (7, N'Student', N'Student life, admissions, campuses');
    PRINT '  - Inserted tag: #Student';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 8)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (8, N'Science', N'Space, physics, biology breakthroughs');
    PRINT '  - Inserted tag: #Science';
END;

IF NOT EXISTS (SELECT 1 FROM Tag WHERE TagID = 9)
BEGIN
    INSERT INTO Tag (TagID, tag_name, Note) VALUES (9, N'Lifestyle', N'Leisure, food, travel, fashion');
    PRINT '  - Inserted tag: #Lifestyle';
END;


-- 4. SEED NEWS ARTICLE
PRINT 'Seeding news_article...';

IF NOT EXISTS (SELECT 1 FROM news_article WHERE news_articleID = 'NEWS-001')
BEGIN
    INSERT INTO news_article (news_articleID, news_title, Headline, created_date, news_content, news_source, CategoryID, news_status, created_byid, updated_byid, modified_date)
    VALUES (
        'NEWS-001',
...
IF NOT EXISTS (SELECT 1 FROM news_article WHERE news_articleID = 'NEWS-002')
BEGIN
    INSERT INTO news_article (news_articleID, news_title, Headline, created_date, news_content, news_source, CategoryID, news_status, created_byid, updated_byid, modified_date)
    VALUES (
        'NEWS-002',
...
IF NOT EXISTS (SELECT 1 FROM news_article WHERE news_articleID = 'NEWS-003')
BEGIN
    INSERT INTO news_article (news_articleID, news_title, Headline, created_date, news_content, news_source, CategoryID, news_status, created_byid, updated_byid, modified_date)
    VALUES (
        'NEWS-003',
...
IF NOT EXISTS (SELECT 1 FROM news_article WHERE news_articleID = 'NEWS-004')
BEGIN
    INSERT INTO news_article (news_articleID, news_title, Headline, created_date, news_content, news_source, CategoryID, news_status, created_byid, updated_byid, modified_date)
    VALUES (
        'NEWS-004',
...
IF NOT EXISTS (SELECT 1 FROM news_article WHERE news_articleID = 'NEWS-005')
BEGIN
    INSERT INTO news_article (news_articleID, news_title, Headline, created_date, news_content, news_source, CategoryID, news_status, created_byid, updated_byid, modified_date)
    VALUES (
        'NEWS-005',
...
PRINT 'Seeding news_tag relationship...';

-- NEWS-001 tags: 1 (Breaking), 5 (World)
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-001' AND TagID = 1)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-001', 1);
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-001' AND TagID = 5)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-001', 5);

-- NEWS-002 tags: 1 (Breaking), 3 (Innovation), 8 (Science)
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-002' AND TagID = 1)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-002', 1);
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-002' AND TagID = 3)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-002', 3);
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-002' AND TagID = 8)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-002', 8);

-- NEWS-003 tags: 2 (Economy)
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-003' AND TagID = 2)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-003', 2);

-- NEWS-004 tags: 4 (Championship)
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-004' AND TagID = 4)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-004', 4);

-- NEWS-005 tags: 7 (Student)
IF NOT EXISTS (SELECT 1 FROM news_tag WHERE news_articleID = 'NEWS-005' AND TagID = 7)
    INSERT INTO news_tag (news_articleID, TagID) VALUES ('NEWS-005', 7);

PRINT '  - Seeded Many-to-Many relationships between news_articles and Tags';
